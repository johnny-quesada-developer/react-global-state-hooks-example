...
export const StateDetails: React.FC<PropsWithChildren<StateDetailsProps>> = ({
  label,
  color,
  count,
  renders,
  ...
  return (
    <div
      className={`flex-1 grid grid-cols-2 gap-2 p-4 border-dashed border-2 rounded-lg ${color}`}
    >
      {label && (
